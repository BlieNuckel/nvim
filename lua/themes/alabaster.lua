...
M.polish_hl = {
  treesitter = {
    ...
    ["@variable.definition"] = tree_sitter_colors.func,
    ["@variable.typescript.definition"] = tree_sitter_colors.func,
    ["@variable.declaration"] = tree_sitter_colors.func,
    ["@variable.typescript.declaration"] = tree_sitter_colors.func,
    ["@local.definitions"] = tree_sitter_colors.func,
